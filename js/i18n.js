...
const exInFieldSliderTxt = document.querySelector(
  "#ex__input__field__slider__text",
);
const resultWordCountTxt = document.querySelector("#result__word__count__text");
const resultSentenceCountTxt = document.querySelector(
  "#result__sentence__count__text",
);
const resultAvgSentenceLengthTxt = document.querySelector(
  "#result__avg__sentence__length__text",
);
const mobileSidebarDarkmodeTxt = document.querySelector(
  "#mobile__darkmode__slider__text",
);
const mobileSidebarAdvInputTxt = document.querySelector(
  "#mobile__adv__input__field__slider__text",
);
...
function applyLanguage(lang) {
  ...
  resultAvgSentenceLengthTxt.innerText =
    translations[lang].resultAvgSentenceLengthTxt;
