...
const extendInputEl = document.querySelector(
  `[data-toggle="${TOGGLE_TYPES.EXTEND_INPUT}"]`,
);
const advOptionsEl = document.querySelector(
  `[data-toggle="${TOGGLE_TYPES.ADV_OPTIONS}"]`,
);
